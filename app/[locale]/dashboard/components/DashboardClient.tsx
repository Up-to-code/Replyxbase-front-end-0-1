...
const dashboardData = {
  stats: [
    { 
      id: 'messages', 
      // title key used for translation lookups: 'stats.messages'
      value: '12,450', 
      change: '+24%', 
      trend: 'up',
      icon: MessageSquare,
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-200">
              <div className="flex items-center justify-between mb-6">
                ...
                <select className="bg-gray-50 border-none text-sm text-gray-600 rounded-lg px-3 py-1 focus:ring-0 cursor-pointer hover:bg-gray-100 transition-colors">
                  <option>{t("charts.last7Days")}</option>
                  <option>{t("charts.last30Days")}</option>
                  <option>{t("charts.thisYear")}</option>
                </select>
              </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
              <div className="p-6 border-b border-gray-100 flex justify-between items-center">
                ...
                <button className="text-sm text-blue-600 font-medium hover:text-blue-700">{t("agents.viewAll")}</button>
              </div>
