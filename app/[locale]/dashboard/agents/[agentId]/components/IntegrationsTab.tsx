    ...
    <div className="bg-white border border-gray-100 rounded-xl p-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {['WhatsApp', 'Telegram'].map((channel) => (
          <div key={channel} className="flex items-center justify-between p-4 rounded-xl border border-gray-100 hover:border-gray-300 transition-colors cursor-pointer">
