        ...
        <div className="bg-gray-900 rounded-xl p-8 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 flex items-start justify-between">
            <div>
              ...
              <h3 className="text-3xl font-bold mb-2">$29<span className="text-lg text-gray-400 font-normal">/mo</span></h3>
              <p className="text-gray-400 text-sm">Billed monthly. Next billing date: Dec 23, 2025</p>
            </div>
            <button className="bg-white text-gray-900 hover:bg-gray-100 px-6 py-2.5 rounded-lg text-sm font-semibold transition-colors">
              Upgrade Plan
            </button>
          </div>
        </div>
