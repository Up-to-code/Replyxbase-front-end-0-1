...
export default function LoginPage() {
  ...
  return (
    <Card className="border-gray-200 shadow-xl shadow-gray-200/50 bg-white/80 backdrop-blur-xl">
      ...
      <CardFooter className="flex flex-col gap-4 text-center text-sm text-gray-500 pt-4">
